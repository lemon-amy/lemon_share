            ...
            <div class="col-xs-2 col-sm-6">
                ...
                <div class="header-top-first clearfix">
                    <ul class="social-links clearfix hidden-xs">
                        ...
                        <li class="youtube"><a target="_blank" href="http://sc.chinaz.com"><i class="fa fa-youtube-play"></i></a></li>
        ...
        <div class="row">
            <div class="col-md-3">
                ...
                <div class="header-left clearfix">
                    ...
                    <!-- logo -->
                    <div class="logo">
                        <a href="index.html"><img id="logo" src="/statics/images/logo_red.png" alt="iDea"></a>
                    </div>
                                                ...
                                                <li>
                                                    <div class="row">
                                                        <div class="col-lg-4 col-md-3 hidden-sm">
                                                            ...
                                                            <img src="/statics/images/section-image-3.png" alt="iDea">
                                                        </div>
                                                ...
                                                <li>
                                                    <div class="row">
                                                        <div class="col-sm-4 col-md-6">
                                                            ...
                                                            <img src="/statics/images/section-image-1.png" alt="image-1">
                                                        </div>
