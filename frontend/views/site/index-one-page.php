    ...
    <div class="container">
        ...
        <div class="row grid-space-20">
            <div class="col-md-3 col-sm-6">
                <div class="box-style-1 white-bg team-member">
                    <div class="overlay-container">
                        <img src="/statics/images/team-member-1.jpg" alt="">
                        <div class="overlay">
            ...
            <div class="col-md-3 col-sm-6">
                <div class="box-style-1 white-bg team-member">
                    <div class="overlay-container">
                        <img src="/statics/images/team-member-2.jpg" alt="">
                        <div class="overlay">
                            <ul class="social-links clearfix">
                                <li class="twitter"><a target="_blank" href="http://sc.chinaz.com"><i class="fa fa-twitter"></i></a></li>
                                <li class="skype"><a target="_blank" href="http://sc.chinaz.com"><i class="fa fa-skype"></i></a></li>
            ...
            <div class="col-md-3 col-sm-6">
                <div class="box-style-1 white-bg team-member">
                    <div class="overlay-container">
                        <img src="/statics/images/team-member-3.jpg" alt="">
                        <div class="overlay">
                            <ul class="social-links clearfix">
                                <li class="twitter"><a target="_blank" href="http://sc.chinaz.com"><i class="fa fa-twitter"></i></a></li>
                                <li class="skype"><a target="_blank" href="http://sc.chinaz.com"><i class="fa fa-skype"></i></a></li>
            ...
            <div class="col-md-3 col-sm-6">
                <div class="box-style-1 white-bg team-member">
                    <div class="overlay-container">
                        <img src="/statics/images/team-member-4.jpg" alt="">
                        <div class="overlay">
                            <ul class="social-links clearfix">
                                <li class="twitter"><a target="_blank" href="http://sc.chinaz.com"><i class="fa fa-twitter"></i></a></li>
                                <li class="skype"><a target="_blank" href="http://sc.chinaz.com"><i class="fa fa-skype"></i></a></li>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-6 object-non-visible" data-animation-effect="fadeInRightSmall" data-effect-delay="300">
                ...
                <img src="/statics/images/services-1.png" alt="iDea">
            </div>
        </div>
        <div class="space"></div>
    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="owl-carousel content-slider-with-controls">
                                                    <div class="overlay-container">
                                                        <img src="/statics/images/portfolio-item-1.jpg" alt="">
                                                    </div>
                                                    <div class="overlay-container">
                                                        <img src="/statics/images/portfolio-item-2.jpg" alt="">
                                                    </div>
                                                    <div class="overlay-container">
                                                        <img src="/statics/images/portfolio-item-3.jpg" alt="">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
